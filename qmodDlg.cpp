...
void CQmodDlg::OnMana()
{
	...
	unsigned char dataarr[6] = { 0x90,0x90,0x90,0x90,0x90,0x90 };
	GhiDuLieu1(L"Virtual Villagers - New Believers WndCls", L"Virtual Villagers - New Believers", NULL, 0x5A9E3, dataarr, 6);
}
