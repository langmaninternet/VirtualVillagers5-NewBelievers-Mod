...
void CQmodDlg::OnTimer(UINT_PTR nIdEvent)
{
	if (mainTimerID == nIdEvent)
	{
		...
		unsigned char always_get_skill_point[28] = { 0xD9, 0x04, 0x8E,
			0xD8, 0x44, 0x24, 0x0C,			
			0xD8, 0x44, 0x24, 0x0C,
			0xD8, 0x44, 0x24, 0x0C,
			0xD8, 0x44, 0x24, 0x0C,
		...
		GhiDuLieu0(pid, handle, 0x357C0, always_get_skill_point, 28);
...
/************************************************************************/
/* For module name is same as execute file name                          */
